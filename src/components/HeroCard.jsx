...
const HeroCard = ({ data }) => {
  return (
    <div className="max-w-xs flex flex-col gap-3 bg-blue-300 border border-blue-200 rounded-lg shadow dark:bg-blue-800 dark:border-blue-700 hover:bg-blue-200">
      ...
      <div className="p-3">
        <div className="text-gray-900 font-bold text-2xl mb-2">{data.name}</div>
        <div className="grid grid-cols-2 text-gray-700 self-center">
          <div>
            ...
            <p className="text-sm">
              Height:{" "}
              {`${data.appearance.height[0]} or ${data.appearance.height[1]}`}
            </p>
            <p className="text-sm">
              Weight:{" "}
              {`${data.appearance.weight[0]} or ${data.appearance.weight[1]}`}
            </p>
