  ...
  return (
    <div>
      <div className="flex flex-col">
        ...
        onClick={onMenu}>Appearance</button>
        { openMenu && (
          <div className="flex flex-col absolute mt-8 ml-5 pr-3 pl-2 py-2 gap-2 bg-sky-500 rounded-lg"> 
            ...
            <button
            className=" bg-red-700 text-white px-2 rounded-lg"
            onClick={filterWeight}>Weight</button>
            <button
            className=" bg-red-700 text-white px-2 rounded-lg"
            onClick={filterEyeColor}>Eye Color</button>
            <button
            className=" bg-red-700 text-white px-2 rounded-lg"
            onClick={filterHairColor}>Hair Color</button>
          </div>
          )
        }
        { openMenuGender && (
              <div className="flex flex-col absolute mt-8 -ml-14 py-2 pr-2 pl-2 gap-2 bg-sky-500 rounded-l-lg"
              type="button">
                <button 
