...
export const getHeroeFiltroIntelligence = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await heroSlice.getHeroeForA();
      const resultsData = response.data.results.filter(
        (data) =>
      ...
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.powerstats.intelligence.split(" ")[0]) &&
          !isNaN(b.powerstats.intelligence.split(" ")[0])
        ) {
          return (
            parseInt(a.powerstats.intelligence.split(" ")[0]) -
            parseInt(b.powerstats.intelligence.split(" ")[0])
          );
        }
...
export const getHeroeFiltroStrength = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.powerstats.strength.split(" ")[0]) &&
          !isNaN(b.powerstats.strength.split(" ")[0])
        ) {
          return (
            parseInt(a.powerstats.strength.split(" ")[0]) -
            parseInt(b.powerstats.strength.split(" ")[0])
          );
        }
...
export const getHeroeFiltroSpeed = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.powerstats.speed.split(" ")[0]) &&
          !isNaN(b.powerstats.speed.split(" ")[0])
        ) {
          return (
            parseInt(a.powerstats.speed.split(" ")[0]) -
            parseInt(b.powerstats.speed.split(" ")[0])
          );
        }
...
export const getHeroeFiltroDurability = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.powerstats.durability.split(" ")[0]) &&
          !isNaN(b.powerstats.durability.split(" ")[0])
        ) {
          return (
            parseInt(a.powerstats.durability.split(" ")[0]) -
            parseInt(b.powerstats.durability.split(" ")[0])
          );
        }
...
export const getHeroeFiltroPower = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.powerstats.power.split(" ")[0]) &&
          !isNaN(b.powerstats.power.split(" ")[0])
        ) {
          return (
            parseInt(a.powerstats.power.split(" ")[0]) -
            parseInt(b.powerstats.power.split(" ")[0])
          );
        }
...
export const getHeroeFiltroCombat = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.powerstats.combat.split(" ")[0]) &&
          !isNaN(b.powerstats.combat.split(" ")[0])
        ) {
          return (
            parseInt(a.powerstats.combat.split(" ")[0]) -
            parseInt(b.powerstats.combat.split(" ")[0])
          );
        }
...
export const getHeroeFiltroGenderMale = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsData = response.data.results.filter(
        (data) =>
          data.appearance.gender !== "null" &&
          data.appearance.gender === "Male" &&
          data.biography.alignment === "good"
      );
      const resultsDataFilter = resultsData.sort((a, b) => {
        if (
          !isNaN(a.appearance.gender.split(" ")[0]) &&
          !isNaN(b.appearance.gender.split(" ")[0])
        ) {
          return (
            a.appearance.gender.split(" ")[0] -
            b.appearance.gender.split(" ")[0]
          );
        }
...
export const getHeroeFiltroEyeColor = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsData = response.data.results.filter(
        (data) =>
          data.appearance["eye-color"] !== "null" &&
...
export const getHeroeFiltroHairColor = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const resultsData = response.data.results.filter(
        (data) =>
          data.appearance["hair-color"] !== "null" &&
